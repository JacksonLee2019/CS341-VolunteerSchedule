...
var appRoutes = [
    { path: 'admin', component: index_1.AdminComponent, canActivate: [index_6.AuthGuard] },
    { path: 'volunteer', component: index_3.VolunteerComponent, canActivate: [index_6.AuthGuard] },
    { path: 'manager', component: index_2.ManagerComponent, canActivate: [index_6.AuthGuard] },
